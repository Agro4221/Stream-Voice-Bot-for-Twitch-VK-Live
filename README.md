...
Для GPU-режима Windows-система должна иметь совместимый NVIDIA-драйвер и библиотеки **CUDA 12.x / cuBLAS / cuDNN 9**. Сам EXE не тащит полный CUDA runtime внутрь сборки; эти системные библиотеки остаются внешними зависимостями GPU-режима.
