...
Launcher при первом запуске устанавливает/обновляет окружение, запускает бота без отдельного окна консоли и ждёт готовности локальной админки. После автоматического открытия админки окно CMD закрывается.
