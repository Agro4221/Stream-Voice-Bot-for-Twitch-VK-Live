...
Субтитры (сабы) пока могут работать нестабильно: возможны пропуски или некорректные обновления дорожек. Работа по исправлению и улучшению субтитров ведётся.

## 🙏 Немного от автора

Это проект новичка, поэтому прошу не судить слишком строго. Я постепенно разбираюсь, исправляю ошибки и улучшаю проект ^_^
